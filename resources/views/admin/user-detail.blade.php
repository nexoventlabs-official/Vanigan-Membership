      ...
      <div>
        <div class="section">
          ...
          <div class="section-body">
            ...
            <div class="detail-item"><span class="detail-label">Zone</span><span class="detail-value">{{ $member->zone }} <span style="display:inline-block;font-size:0.65rem;font-weight:700;color:#fff;background:#009245;border-radius:4px;padding:1px 6px;margin-left:4px;vertical-align:middle;text-transform:uppercase;letter-spacing:0.4px;">Zone</span></span></div>
            @endif
            @if(!empty($member->dob))
