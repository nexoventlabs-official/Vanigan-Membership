...
<html lang="en">
  <head>
    ...
    <title>Vanigan ID Card - {{ $member->unique_id ?? '' }}</title>
    <link
  ...
  <body>
    ...
    <div class="card-wrap">
      <p class="meta">Generated: {{ $generated_at ?? now()->format('d M Y, h:i A') }}</p>

      {{-- ── FRONT ── --}}
      <div id="page1-div" class="card-face" style="height: 573px;">
        <div class="front-photo-wrap">
          @if(!empty($member->photo_url))
          <img src="{{ $member->photo_url }}" crossorigin="anonymous" class="rounded img-thumbnail photo" />
          @endif
        </div>
        ...
        <div class="front-stack">
          ...
          <div class="front-meta">
            ...
            <div class="front-line">
              <p class="detail-line">{{ ucwords(strtolower($member->zone ?? '')) }}</p>
            </div>
            <div class="front-line">
      ...
      {{-- ── BACK ── --}}
      <div id="page2-div" class="card-face" style="min-height: 590px; margin-top: 20px;">
        <div class="back-content">
          <div class="back-details">
            <div class="back-row">
              <div class="back-label">DATE OF BIRTH</div>
              <div class="back-sep">:</div>
              <div class="back-value">{{ $member->dob ?? '' }}</div>
            </div>

            <div class="back-row">
              <div class="back-label">AGE</div>
              <div class="back-sep">:</div>
              <div class="back-value">{{ $member->age ?? '' }}</div>
            </div>

            <div class="back-row">
              <div class="back-label">BLOOD GROUP</div>
              <div class="back-sep">:</div>
              <div class="back-value">{{ $member->blood_group ?? '' }}</div>
            </div>

            <div class="back-row">
              <div class="back-label">ADDRESS</div>
              <div class="back-sep">:</div>
              <div class="back-value address">{{ $member->address ?? '' }}</div>
            </div>

            <div class="back-row" style="margin-top: 8px;">
              <div class="back-label">CONTACT</div>
              <div class="back-sep">:</div>
              <div class="back-value"><span class="contact-value">{{ $member->contact_number ?? '' }}</span></div>
            </div>
          </div>

          <div class="back-bottom">
            <div class="qr-wrap">
              <img src="/api/vanigam/qr/{{ $member->unique_id }}" width="96" height="88" alt="QR Code" />
            </div>
            <div class="sign-wrap">
